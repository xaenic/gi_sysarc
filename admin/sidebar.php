...
?>
<aside id="sidebar"
    class="left-[-1000px] lg:left-0 h-[805px] pb-36 duration-300 transition-all  w-56 bg-gradient-to-br from-stone-500 via-stone-600 to-stone-800 p-5 rounded-xs  lg:m-4 text-gray-100 fixed top-0 left-0 bottom-0   flex-col justify-between">
    <div class="h-full text-white  ">
        ...
        <section id="widget_2" class="mt-5 flex flex-col gap-5">
            <div class="flex gap-2 items-center <?php echo($page == 'Search' ? 'bg-stone-800' : '' ) ?>  cursor-pointer text-white rounded-xs px-3 p-2">
                <i class="fa-solid fa-magnifying-glass"></i>
                <a href="./" class="w-full">Search</a>
            </div>
        </section>
         <section id="widget_2" class="mt-5 flex flex-col gap-5">
            <div class="flex gap-2 items-center <?php echo($page == 'View Records' ? 'bg-stone-800' : '' ) ?> text-sm   cursor-pointer text-white rounded-xs px-3 p-2">
            <i class="fa-solid fa-eye"></i>    
            <a href="./records.php" class="w-full">View Records</a>
            </div>
        </section>
          <section id="widget_2" class="mt-5 flex flex-col gap-5">
            <div class="flex gap-2 items-center <?php echo($page == 'Announcements' ? 'bg-stone-800' : '' ) ?> text-sm   cursor-pointer text-white rounded-xs px-3 p-2">
            <i class="fa-solid fa-eye"></i>    
         ...
         <section id="widget_2" class="mt-5 flex flex-col gap-5">
            ...
            <i class="fa-solid fa-eye"></i>    
            <a href="./reports.php" class="w-full">Reports / Feedback</a>
            </div>
        </section>
        <!-- test -->
        <section id="widget_2" class="mt-5 flex flex-col gap-5">
            <div class="flex gap-2 items-center <?php echo($page == 'Generate Reports' ? 'bg-stone-800' : '' ) ?> text-sm cursor-pointer text-white rounded-xs px-3 p-2">
